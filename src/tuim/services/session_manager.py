"""Session lifecycle manager for Tuim."""
from typing import Callable, Optional

from tuim.models import Connection, Protocol
...
class SessionManager:
    ...
    def _create_handler(self, connection):
        ...
        """
        from tuim.protocols.ssh import SSHHandler
        from tuim.protocols.rdp import RDPHandler
        from tuim.protocols.vnc import VNCHandler
        from tuim.protocols.telnet import TelnetHandler
        from tuim.protocols.k8s import K8sHandler
