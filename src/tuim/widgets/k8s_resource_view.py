"""K8s resource browser widget for Tuim TUI."""
...
from tuim.services.k8s_service import K8sService, K8sConnectionError, RESOURCE_ALIASES
...
class K8sResourceView(Widget):
    ...
    def set_k8s_context(self, kubeconfig, context, namespace,
                        token="", insecure_skip_tls_verify=False, host="", port=0):
        # type: (str, str, str, str, bool, str, int) -> None
    ...
    def get_prev_resource_type(self):
        # type: () -> str
        return self._prev_resource_type
    ...
    async def reload_resources(self):
        ...
        try:
            ...
            # Silently keep stale data on background refresh failures
            pass
        self._rebuild_table()
