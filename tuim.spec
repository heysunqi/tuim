...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'tuim.screens.file_transfer_screen', 'tuim.screens.transfer_confirm',
        'tuim.screens.mkdir_screen', 'tuim.screens.k8s_help_screen',
        'tuim.services.sftp_service',
        'tuim.widgets', 'tuim.widgets.header_bar',
        'tuim.widgets.file_panel',
